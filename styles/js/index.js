...
const hE = (e, t) => (qu(e) ? new pE(t, { enableHardwareAcceleration: !1 }) : new dE(t, { enableHardwareAcceleration: !0 })),
    ...
    EE = "/assets/reactjs-966214a8.png",
    PE = "/assets/redux-171787ca.png",
    kE = "/assets/tailwind-6ece120d.png",
    CE = "/assets/sass-b95f493d.png",
    ...
    BE = [
        ...
        { name: "React JS", icon: EE },
        { name: "Redux Toolkit", icon: PE },
        { name: "Tailwind CSS", icon: kE },
        { name: "git", icon: wE },
        { name: "sass", icon: CE },
    ],
    bE = [
        { title: "Frontend Developer", description: "If you have a unique web application idea, I can turn it into reality.", icon: ME },
        { title: "React Developer", description: "I can build powerful single-page applications (SPAs) and dynamic user interfaces.", icon: jE },
        ...
        { title: "User Interface Design", description: "With my keen eye for design and understanding of user experience principles, I can create captivating and user-friendly interfaces.", icon: RE },
    ],
    jo = [
        {
            id: 1,
        ...
        },
        {
            ...
            description: "Movie Application offering features like filtering movies and tv shows by genre, get details about movies and tv shows, get filmography of every person related to the movie and tv shows, etc.",
            image: NE,
                    ...
                    x.jsxs("section", {
                        ...
                        children: [
                            x.jsxs(F.h1, {
                                ...
                                children: ["Hi! I'm ", x.jsx("br", {}), " ", x.jsx("span", { className: "text-yellow-1", children: "Pritam Ghosh" })],
                            }),
                            x.jsx(F.p, {
