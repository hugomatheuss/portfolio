        ...
        x.jsxs("section", {
            ...
            children: [
                ...
                x.jsx(F.div, {
                    ...
                    children: x.jsx(QE, { className: "text-2xl  md:text-4xl ", onClick: () => window.open("https://www.linkedin.com/in/hugo-matheus-freire/", "_blank") }),
                }),
                x.jsx(F.div, {
                    ...
                    children: x.jsx(fv, { className: "text-2xl  md:text-4xl ", onClick: () => window.open("https://github.com/hugomatheuss/", "_blank") }),
                }),
            ],
        }),
    tP = () =>
